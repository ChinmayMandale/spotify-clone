...
export const SongBar = ({ song, i, artistId, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-[#308a54] ${activeSong?.title === song?.title ? 'bg-[#308a54]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
